...
class IndiaPhrasesActivity : AppCompatActivity() {
    private lateinit var listview: ListView
    var arrayList: ArrayList<PharsesData> = ArrayList()
    var adapter: IndiaPhrasesActivity.MyAdapter? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_india_phrases)

        listview = findViewById(R.id.list_items)
        arrayList.add(
            PharsesData(
                getString(R.string.IndPhraseOne),
                getString(R.string.IndExplainOne)
            )
        )
        arrayList.add(
            PharsesData(
                getString(R.string.IndPhraseTwo),
                getString(R.string.IndExplainTwo)
            )
        )
        arrayList.add(
            PharsesData(
                getString(R.string.IndPhraseThree),
                getString(R.string.IndExplainThree)
            )
        )
        arrayList.add(
            PharsesData(

                getString(R.string.IndPhraseFour),
                getString(R.string.IndExplainFour)
            )
        )
        arrayList.add(
            PharsesData(

                getString(R.string.IndPhraseFive),
                getString(R.string.IndExplainFive)
            )
        )
        arrayList.add(
            PharsesData(

                getString(R.string.IndPhraseSix),
                getString(R.string.IndExplainSix)
            )
        )
