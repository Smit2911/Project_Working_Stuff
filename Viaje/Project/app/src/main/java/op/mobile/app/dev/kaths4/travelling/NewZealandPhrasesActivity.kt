...
class NewZealandPhrasesActivity : AppCompatActivity() {
    private lateinit var listview: ListView
    var arrayList: ArrayList<PharsesData> = ArrayList()
    var adapter: NewZealandPhrasesActivity.MyAdapter? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_new_zealand_phrases)

        listview = findViewById(R.id.list_items)
        arrayList.add(
            PharsesData(
                getString(R.string.NzPhraseOne),
                getString(R.string.NzExplainOne)
            )
        )
        arrayList.add(
            PharsesData(
                getString(R.string.NzPhraseTwo),
                getString(R.string.NzExplainTwo)
            )
        )
        arrayList.add(
            PharsesData(
                getString(R.string.NzPhraseThree),
                getString(R.string.NzExplainThree)
            )
        )
        arrayList.add(
            PharsesData(

                getString(R.string.NzPhraseFour),
                getString(R.string.NzExplainFour)
            )
        )
        arrayList.add(
            PharsesData(

                getString(R.string.NzPhraseFive),
                getString(R.string.NzExplainFive)
            )
        )
        arrayList.add(
            PharsesData(

                getString(R.string.NzPhraseSix),
                getString(R.string.NzExplainSix)
            )
        )
