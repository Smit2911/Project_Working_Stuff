...
class SingaporePhrasesActivity : AppCompatActivity() {
    private lateinit var listview: ListView
    var arrayList: ArrayList<PharsesData> = ArrayList()
    var adapter: SingaporePhrasesActivity.MyAdapter? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_singapore_phrases)

        listview = findViewById(R.id.list_items)
        arrayList.add(
            PharsesData(
                getString(R.string.SinPhraseOne),
                getString(R.string.SinExplainOne)
            )
        )
        arrayList.add(
            PharsesData(
                getString(R.string.SinPhrasesTwo),
                getString(R.string.SinExplainTwo)
            )
        )
        arrayList.add(
            PharsesData(
                getString(R.string.SinPhrasesThree),
                getString(R.string.SinExplainThree)
            )
        )
        arrayList.add(
            PharsesData(

                getString(R.string.SinPhrasesFour),
                getString(R.string.SinExplainFour)
            )
        )
        arrayList.add(
            PharsesData(

                getString(R.string.SinPhrasesFive),
                getString(R.string.SinExplainFive)
            )
        )
        arrayList.add(
            PharsesData(

                getString(R.string.SinPhrasesSix),
                getString(R.string.SinExplainSix)
            )
        )
