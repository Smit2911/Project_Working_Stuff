...
class UnitedKingdomPhrasesActivity : AppCompatActivity() {
    private lateinit var listview: ListView
    var arrayList: ArrayList<PharsesData> = ArrayList()
    var adapter: UnitedKingdomPhrasesActivity.MyAdapter? = null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_united_kingdom_phrases)

        listview = findViewById(R.id.list_items)
        arrayList.add(
            PharsesData(
                getString(R.string.UkPhraseOne),
                getString(R.string.UkExplainOne)
            )
        )
        arrayList.add(
            PharsesData(
                getString(R.string.UkPhraseTwo),
                getString(R.string.UkExplainTwo)
            )
        )
        arrayList.add(
            PharsesData(
                getString(R.string.UkPhraseThree),
                getString(R.string.UkExplainThree)
            )
        )
        arrayList.add(
            PharsesData(

                getString(R.string.UkPhraseFour),
                getString(R.string.UkExplainFour)
            )
        )
        arrayList.add(
            PharsesData(

                getString(R.string.UkPhraseFive),
                getString(R.string.UkExplainFive)
            )
        )
        arrayList.add(
            PharsesData(

                getString(R.string.UkPhraseSix),
                getString(R.string.UkExplainSix)
            )
        )
