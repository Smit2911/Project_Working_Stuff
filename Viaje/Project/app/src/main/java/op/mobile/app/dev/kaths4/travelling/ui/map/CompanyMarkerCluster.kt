...
import op.mobile.app.dev.kaths4.travelling.databinding.ClusterMarkerBinding
import op.mobile.app.dev.kaths4.travelling.databinding.ClusterMarkerInfoWindowBinding
...
class CompanyMarkerCluster(
    ...
    inner class InfoWindowAdapter : GoogleMap.InfoWindowAdapter {
        ...
        override fun getInfoWindow(marker: Marker): View {
            ...
            binding.tvLat.text = company.latLng.toString()
            return binding.root
        }
